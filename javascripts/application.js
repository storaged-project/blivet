...
(function() {
  if (!(window.console && console.log)) {
    (function() {
      var console, length, methods, noop, results;
      noop = function() {};
      ...
      results = [];
      while (length--) {
        results.push(console[methods[length]] = noop);
      }
      return results;
    })();
  }
...
(function() {
  String.prototype.score = function(abbreviation) {
    var abbreviation_length, abbreviation_score, c, character_score, final_score, i, index_c_lowercase, index_c_uppercase, index_in_string, j, len, min_index, should_award_common_prefix_bonus, string, string_length, total_character_score;
    string = this;
